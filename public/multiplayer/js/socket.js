...
var multiplayerSettings = {
	...
	forceQuit:false, //everyone quit game if one player is leaved
	findPlayerTimer:true, //show quick match time
	game:'guessthesketch', //(guessthesketch, bingobash, spotthedifferences, snakesandladders, quizgamevs, tictactoe, connectfour, wordsearch, feedmonster, slotcarchallenge, playreversi, playcheckers, playchess, wheeloffortunequiz, circlejump, findme)
}
...
//games
function postSocketUpdate(status, data){
